...
@section('content')
  <div class="mt-2 mb-4">
    <h2 class=" pb-2 ">{{ __('Welcome back') .','}} {{ Auth::guard('venue')->user()->username . '!' }}</h2>
  </div>

  @if (Session::get('secret_login') != true)
    @if (Auth::guard('venue')->user()->status == 0 && $admin_setting->venue_admin_approval == 1)
      <div class="mt-2 mb-4">
  ...
  <div class="row dashboard-items">
    <div class="col-xl-3 col-lg-6">
      <a href="{{ route('venue.monthly_income') }}">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  ...
                  <h4 class="card-title">
                    ...
                    {{ round(Auth::guard('venue')->user()->amount, 2) }}
