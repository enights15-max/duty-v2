...
@section('content')
  ...
  <div class="product-type">
    ...
    <div class="row">
      <div class="col-lg-6">
        <a href="{{ route('venue.add.event.event', ['type' => 'online']) }}" class="d-block text-decoration-none">
      ...
      <div class="col-lg-6">
        <a href="{{ route('venue.add.event.event', ['type' => 'venue']) }}" class="d-block text-decoration-none">
          <div class="card card-stats card-round p-50">
            <div class="card-body ">
              <div class="row align-items-center">
                <div class="col-12">
