    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="ajaxEditForm" class="modal-form create" action="{{ route('admin.withdraw_payment_method.update') }}"
          ...
          <h6 class="scarlet-modal__title">{{ __('Update withdrawal method') }}</h6>
          <p class="scarlet-modal__intro">
            {{ __('Refine the payout configuration without leaving the operations workspace. Changes here affect future withdrawals immediately.') }}
          </p>
          ...
          <div class="scarlet-modal__section">
            <div class="scarlet-inline-note mb-3">
              {{ __('You can keep this method paused while testing or switch it live once finance is ready to accept requests.') }}
            </div>
