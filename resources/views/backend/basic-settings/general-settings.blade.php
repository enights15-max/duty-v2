                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview">
                                                @if (!empty($data->favicon))
                                                    <img src="{{ asset('assets/admin/img/' . $data->favicon) }}"
                                                        alt="favicon" class="uploaded-img">
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview">
                                                @if (!empty($data->preloader))
                                                    <img src="{{ asset('assets/admin/img/' . $data->preloader) }}"
                                                        alt="Preloader" class="uploaded-img3">
                                                @else
                                                    <img src="{{ asset('assets/admin/img/noimage.jpg') }}" alt="..."
                                                        class="uploaded-img3">
                                                @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview">
                                                @if (!empty($data->logo))
                                                    <img src="{{ asset('assets/admin/img/' . $data->logo) }}"
                                                        alt="logo" class="uploaded-img2">
                                                @else
                                                    <img src="{{ asset('assets/admin/img/noimage.jpg') }}" alt="..."
                                                        class="uploaded-img2">
                                                @endif
