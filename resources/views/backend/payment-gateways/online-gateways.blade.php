                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p><strong class="text-warning">Your Success URL :</strong> <br>
                                    {{ url('/') }}/event-booking/bank-notify </p>
                                <p><strong class="text-warning">Your Cancel URL :</strong> <br>
                                    {{ url('/') }}/midtrans/cancel </p>
                                <p>
                                    <strong class="text-warning">Set these URLs in Midtrans Dashboard like this :</strong>
                                    <br> <a href="https://prnt.sc/OiucUCeYJIXo"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->has('paypal_sandbox_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('paypal_sandbox_status') }}
                                        </p>
                                    @endif
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <strong class="text-warning">Set the cron job following this video: </strong> <a
                                    href="https://www.awesomescreenshot.com/video/25404126?key=3f7a7fa8cf2391113bb926f43609fa56"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="mt-1 mb-0 text-warning">
                                        {{ __("You will get your 'API Endpoit' from PayTabs Dashboard.") }}</p>
