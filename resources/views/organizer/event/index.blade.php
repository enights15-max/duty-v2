...
=======
        ...
        <details class="event-index-advanced" {{ $statusFilter !== 'all' || $featuredOnly || $activeLanguage !== $defaultLang->code || $viewMode === 'grid' ? 'open' : '' }}>
          ...
          <form action="{{ route('organizer.event_management.event') }}" method="get" class="event-index-advanced__form">
                  ...
                  <tr class="{{ $event->is_expired ? 'is-expired' : 'is-current' }}">
                    ...
                    <td>
                      <div class="event-index-organizer">
                        ...
                        <span class="event-index-organizer__badge">{{ __('Organizer') }}</span>
                      </div>
                    </td>
                    <td>
                      <div class="event-index-state-stack">
                        @if ($event->event_type === 'venue')
                          <a href="{{ route('organizer.event.ticket', ['language' => $activeLanguage, 'event_id' => $event->id, 'event_type' => $event->event_type]) }}" class="event-index-ticket-button">
                        ...
                        <form id="statusForm-{{ $event->id }}" action="{{ route('organizer.event_management.event.event_status', ['id' => $event->id, 'language' => $activeLanguage]) }}" method="post">
                          @csrf
                        ...
                        @unless ($event->is_expired)
                          <form id="featuredForm-{{ $event->id }}" action="{{ route('organizer.event_management.event.update_featured', ['id' => $event->id]) }}" method="post">
                            @csrf
                    ...
                    <td>
                      <div class="event-index-actions">
                        <a href="{{ route('organizer.event_management.edit_event', ['id' => $event->id]) }}" class="event-index-primary-action">
                        ...
                        <div class="dropdown event-index-manage">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('organizer.event_management.qr', ['id' => $event->id]) }}" class="dropdown-item">
                              {{ __('Event QR') }}
                            </a>
                            <a href="{{ route('organizer.event_management.ticket_setting', ['id' => $event->id]) }}" class="dropdown-item">
                              {{ __('Ticket Settings') }}
                            </a>
                  ...
                  <article class="event-index-card {{ $event->is_expired ? 'is-expired' : 'is-current' }}">
                    ...
                    <div class="event-index-card__body">
                      ...
                      <div class="event-index-card__ops">
                        ...
                        <form id="grid-statusForm-{{ $event->id }}" action="{{ route('organizer.event_management.event.event_status', ['id' => $event->id, 'language' => $activeLanguage]) }}" method="post">
                          @csrf
                        ...
                        @unless ($event->is_expired)
                          <form id="grid-featuredForm-{{ $event->id }}" action="{{ route('organizer.event_management.event.update_featured', ['id' => $event->id]) }}" method="post">
                            @csrf
                      ...
                      <div class="event-index-card__footer">
                        <a href="{{ route('organizer.event_management.edit_event', ['id' => $event->id]) }}" class="event-index-primary-action event-index-primary-action--block">
                          <i class="fas fa-pen"></i>
                          {{ __('Edit') }}
                        </a>
