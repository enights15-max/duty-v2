            ...
            <div class="card">
                <div class="card-header p-1">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <form action="{{ route('organizer.event_bookings.export') }}"
                                class="form-inline justify-content-lg-end justify-content-start">
                                <div class="form-group">
                                        ...
                                        <tbody>
                                            @foreach ($bookings as $key => $booking)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('event.details', ['slug' => $booking->slug, 'id' => $booking->event_id]) }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <iframe
                                                                    src="{{ asset('assets/admin/file/invoices/' . $booking->invoice) }}"
