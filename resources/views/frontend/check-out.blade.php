...
@section('content')
    <!-- CheckOut Area Start -->
    <section class="checkout-area checkout-area-v2 pt-120 rpt-95 pb-90 rpb-70">
        <div class="container">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar">
                                                ...
                                                <div class="slot-box-wrap">
                                                    @foreach ($selTickets as $selTicket)
                                                        ...
                                                        @if (array_key_exists('seat_id', $selTicket) &&
                                                                ...
                                                                array_key_exists('slot_name', $selTicket) &&
                            ...
                            @if ($total != 0 || Session::get('sub_total') != 0)
                                ...
                                @endif
                                <div class="form-group">
                                    <select name="gateway" class="nice-select" id="payment">
