...
class CardSetupSheet extends StatefulWidget {
  final String clientSecret;
  final String? title;

  const CardSetupSheet({super.key, required this.clientSecret, this.title});
  ...
  static Future<bool> show({
    ...
    final result = await showModalBottomSheet<bool>(
      ...
      builder: (_) => CardSetupSheet(clientSecret: clientSecret, title: title),
    );
    return result ?? false;
  }

  @override
  State<CardSetupSheet> createState() => _CardSetupSheetState();
}

class _CardSetupSheetState extends State<CardSetupSheet> {
  ...
  Future<void> _pay() async {
    ...
    try {
      ...
      final success = await StripeService.instance.confirmCustomSetupIntent(
      ...
      setState(() {
        _errorMessage = "Failed to save card. Please check your details.";
        _isProcessing = false;
      });
    }
  }
