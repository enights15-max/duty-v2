    ...
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            @if (!empty($variation))
                ...
                <li class="nav-item">
                    <a
                        href="{{ route('admin.event.edit.ticket', ['language' => $defaultLang->code, 'event_id' => $event_id, 'id' => $ticket_id, 'event_type' => $event_type]) }}">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="mr-2 btn btn-success btn-sm float-right d-inline-block" href="{{ route('event.details', [
                    'slug' => eventSlug($defaultLang->id,$event_id),
                    'id' => $event_id]) }}" target="_blank">
                        <span class="btn-label">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function drawBox(
                ...
                box.draggable({
                    ...
                    stop: function(event, ui) {
                        ...
                        var ticket_id = ticket_id;
                        var slot_unique_id = slot_unique_id;
                        var url = "{{ route('admin.event_management.seat_mapping.slot.drup_drop') }}";
                    ...
                    .click(function(e) {
                        ...
                        if (slot_id) {
                            if (slot_booked == 0) {
                                $(".request-loader").addClass('show');
                                var form_url =
                                    "{{ route('admin.event_management.seat_mapping.slot.delete') }}";
                                $.ajax({
                                    url: form_url,
                                    type: 'POST',
                                    data: {
            ...
            $('#submit-button').click(function() {
                $(".request-loader").addClass('show');
                var url = "{{ route('admin.event_management.seat_mapping.slot.store_update') }}"
            ...
            $(".seat_map_modal").click(function(e) {
                ...
                let url = "{{ route('admin.event_management.seat_mapping.slot.seat_mapping') }}";
