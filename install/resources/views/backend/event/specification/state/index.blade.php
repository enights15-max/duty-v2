...
@section('content')
            ...
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.event_management.bulk-delete_state') }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($states) == 0)
                                <h3 class="text-center mt-2">{{ __('NO STATES FOUND') . '!' }}</h3>
                            @else
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-xs mr-1 mt-1"
                                                            href="{{ route('admin.event_management.edit_state', ['id' => $state->id, 'language' => $state->language_id]) }}">
                                                        ...
                                                        <form class="deleteForm d-inline-block"
                                                            action="{{ route('admin.event_management.delete_state', ['id' => $state->id]) }}"
                                                            method="post">
                ...
                <div class="card-footer d-flex justify-content-center">
                    {{ $states->appends(['language' => $defaultLang->code])->links() }}
                </div>
            </div>
        </div>
    </div>
    ...
    {{-- create modal --}}
    @include('backend.event.specification.state.create')
@endsection
@section('script')
    <script>
