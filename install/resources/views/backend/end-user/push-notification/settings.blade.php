                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview">
                                        @if (!is_null($data->notification_image))
                                            <img src="{{ asset('assets/admin/img/' . $data->notification_image) }}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="ml-3 mb-0 text-light">
                                            <a href="//www.attheminute.com/vapid-key-generator/" target="_blank"
